...
class SessionGuard implements StatefulGuard, SupportsBasicAuth
{
     ...
     * 获取当前认证的用户
     *
     * @return \Illuminate\Contracts\Auth\Authenticatable|null    返回\Illuminate\Foundation\Auth\User类的实例对象
     */
    public function user()
    {
        ...
        $id = $this->session->get($this->getName());  //对于当前用户的查找是通过session机制完成的   session是Illuminate\Session\Store类的实例
    ...
    {
        return 'login_'.$this->name.'_'.sha1(get_class($this));  //login_web_sha1(get_class($this));
    }
