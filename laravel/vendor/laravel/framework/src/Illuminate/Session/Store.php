...
class Store implements SessionInterface
{
    ...
    {
        $this->setId($id);  //设置sessionID，等价于session.name的值
        $this->name = $name;
    ...
    {
        $this->attributes = array_merge($this->attributes, $this->readFromHandler());  //根据sessionID将对应的数据从相应的存储媒介中取出来，放到Store类实例的$attributes属性数组中。
