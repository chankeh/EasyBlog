...
class Container implements ArrayAccess, ContainerContract
{
     ...
     * 注册一个绑定到容器中，$shared=true表示是一个共享的绑定，即singleton
     *
    ...
    protected function getMethodDependencies($callback, array $parameters = [])
    {
        ...
        foreach ($this->getCallReflector($callback)->getParameters() as $parameter) {  ////// new ReflectionMethod()
    ...
    protected function addDependencyForCallParameter(ReflectionParameter $parameter, array &$parameters, &$dependencies)
    {
        if (array_key_exists($parameter->name, $parameters)) {
            ...
            $dependencies[] = $this->make($parameter->getClass()->name);  ////// 举例 解析Router $this->make('Route');
     ...
     * @return mixed
     *
     * $app['config'] 等价于 $app->make('config')
     */
