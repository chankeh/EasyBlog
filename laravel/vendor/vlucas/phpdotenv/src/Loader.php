...
class Loader
{
     ...
     * @return void
     */
    public function __construct($filePath, $immutable = false)  // immutable 不可变的
    {
    ...
    public function load()
    {
        ...
        foreach ($lines as $line) {
                   //return strpos(trim($line), '#') === 0;  //return strpos($line, '=') !== false;
            if (!$this->isComment($line) && $this->looksLikeSetter($line)) {   //语义化明确，如果不是注释并且看上去像设置器
