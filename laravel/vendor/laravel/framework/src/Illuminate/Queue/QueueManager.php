...
class QueueManager implements FactoryContract, MonitorContract
{
    ...
    {
        $name = $name ?: $this->getDefaultDriver();  // return $this->app['config']['queue.default'];   return 'sync';
    ...
    {
        $config = $this->getConfig($name);  // return $this->app['config']["queue.connections.{$name}"];   return ['driver' => 'sync'];

        return $this->getConnector($config['driver'])->connect($config);  // $this->getConnector('sync')->connect($config);
    }
    ...
    protected function getConnector($driver)
    {
        if (isset($this->connectors[$driver])) {
            return call_user_func($this->connectors[$driver]);  //return call_user_func($this->connectors['sync']);
        }
