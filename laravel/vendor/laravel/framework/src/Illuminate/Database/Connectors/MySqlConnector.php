...
class MySqlConnector extends Connector implements ConnectorInterface
{
    ...
    public function connect(array $config)
    {
        ...
        $options = $this->getOptions($config);  //为空
    ...
    {
        return $this->configHasSocket($config) ? $this->getSocketDsn($config) : $this->getHostDsn($config);  //调用getHostDsn($config);
    }
